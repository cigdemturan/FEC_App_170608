        ...
        static void Main(string[] args)
        {
            ...
            if (_sensor != null)
            {
                ...
                if (_sensor.IsOpen)
                {
                    ...
                    _multiSourceFrameReader = _sensor.OpenMultiSourceFrameReader(FrameSourceTypes.Color |FrameSourceTypes.Depth | FrameSourceTypes.Body | FrameSourceTypes.BodyIndex);
